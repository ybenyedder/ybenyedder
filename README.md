...
* **Backend & Sync :** Supabase (PostgreSQL, Realtime, RLS)
* **Sécurité :** Cryptographie (HMAC-SHA256), Obfuscation de code, Anti-triche
* **Moteur Web :** WebGL, Web Audio API, Manipulation DOM complexe
